...
echo "Using default model: jina-reranker-v1-tiny-en.f16.gguf"
echo "========================================"

# https://github.com/ggml-org/llama.cpp/pull/9510 (ggerganov)
curl -k https://127.0.0.1:5000/v1/rerank   -H "Content-Type: application/json"     -d '{
